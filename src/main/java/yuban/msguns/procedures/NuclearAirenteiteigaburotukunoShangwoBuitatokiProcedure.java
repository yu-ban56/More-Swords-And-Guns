...
public class NuclearAirenteiteigaburotukunoShangwoBuitatokiProcedure {
	public static void execute(Entity entity) {
		...
		if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == MsgunsModItems.LEAD_ARMOR_HELMET.get()
			...
			if (entity instanceof LivingEntity _entity)
				_entity.addEffect(new MobEffectInstance(MsgunsModMobEffects.NUCLEAR_EFFECT.get(), 160, 1, (false), (false)));
		} else {
			if (entity instanceof LivingEntity _entity)
				_entity.addEffect(new MobEffectInstance(MsgunsModMobEffects.NUCLEAR_EFFECT.get(), 20, 1, (false), (false)));
		}
	}
}
