...
import yuban.msguns.procedures.EnergyGunFeibiDaoJugaburotukuniDangtatutatokiProcedure;
...
public class EnergyGunEntity extends AbstractArrow implements ItemSupplier {
	public EnergyGunEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MsgunsModEntities.ENERGY_GUN.get(), world);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		EnergyGunFeibiDaoJugaburotukuniDangtatutatokiProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static EnergyGunEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EnergyGunEntity entityarrow = new EnergyGunEntity(MsgunsModEntities.ENERGY_GUN.get(), entity, world);
	...
	public static EnergyGunEntity shoot(LivingEntity entity, LivingEntity target) {
		EnergyGunEntity entityarrow = new EnergyGunEntity(MsgunsModEntities.ENERGY_GUN.get(), entity, entity.level);
